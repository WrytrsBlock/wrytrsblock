  ...
  return (
    <aside className="hidden lg:flex flex-col w-[264px] shrink-0 relative isolate overflow-hidden border-r border-white/[0.07] bg-surface/45 backdrop-blur-2xl shadow-[inset_-1px_0_0_rgb(255_255_255/0.04)]">
      ...
      <img
        ...
        aria-hidden
        draggable={false}
        className="pointer-events-none absolute left-[44%] top-[78%] -z-10 w-[616px] max-w-none -translate-x-1/2 -translate-y-1/2 select-none opacity-[0.21] blur-[1.5px] dark:invert"
      />
