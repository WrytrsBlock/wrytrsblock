...
//
// 16:10 cover image on top, a separate solid meta bar below (title, status,
// arrow-to-open) — restored to match the original mobile design rather than
// the full-bleed overlay this briefly became.
  ...
  return (
    ...
    >
      <div className="relative aspect-[16/10] overflow-hidden">
        ...
        {/* Change cover — right on the image. Nested inside the card's Link, so
